...
const MovieCard: React.FC<MovieCardProps> = ({ item, type }) => {
  ...
  return (
    <Link href={`/${type}/${item.id}`}>
      <div className="group cursor-pointer bg-gray-800 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
